...
If you are a lawyer, legal researcher, or other legal professional:
...
- **Professional Rules**: Law Society of Mauritius members must comply with applicable professional conduct rules when using AI tools
...
1. Checking the official source (Mauritius Law Reports (mauritianlaw.org), Mauritius Gazette)
...
This Tool aggregates data from official Mauritius legal databases. However:

| Source Type | Authority Level | Use Case |
|------------|----------------|----------|
| **Official government databases** | Authoritative | Statute text (primary reference) |
| **Community/open-data sources** | Supplementary | Case law, cross-references (verify independently) |
| **EUR-Lex / treaty databases** | Authoritative for international law | International obligations metadata |
...
- Mauritius law changes continuously through new statutes, amendments, and court decisions
...
- Always check official sources for the current legal position

### Amendments and Repeals

- A provision marked "in force" may have been:
  - Amended after the last database update
  - Repealed but not yet removed from the database
  - Subject to transitional rules affecting its applicability
...
1. **Complete case law** -- Coverage is limited; do not rely solely on this for case law research
...
5. **Full legislative history** -- Limited coverage of preparatory works and explanatory memoranda
...
- **International Law Blind Spots**: Cannot fully assess international treaty obligations or compliance
...
- See [PRIVACY.md](PRIVACY.md) for detailed confidentiality considerations (if available)
...
2. **Official Verification**: Cross-check ALL results with official sources (Mauritius Law Reports (mauritianlaw.org), Mauritius Gazette)
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Mauritius-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Mauritius-law-mcp/issues
...
- **ALWAYS VERIFY** all legal information with official sources
...
- **COMPLY** with professional ethics rules regarding AI tool use and client confidentiality
