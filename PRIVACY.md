...
This document addresses privacy and confidentiality considerations when using this Tool, with particular attention to professional obligations under Mauritian legal professional rules.
...
- Law Society of Mauritius rules require strict confidentiality and data handling controls

**Safe Use Options:**
1. **General Legal Research**: Use Tool for non-client-specific queries
2. **Local npm Package**: Install `@ansvar/mauritian-law-mcp` locally — database queries stay on your machine
...
## Professional Obligations (Mauritius)

### Law Society of Mauritius and Advocates Act

Mauritian lawyers (advocates) are bound by strict confidentiality rules under the Advocates Act (Cap 16) and the Law Society of Mauritius Code of Standards of Professional Practice and Ethical Conduct.

#### Advocate-Client Privilege

- All advocate-client communications are privileged under the Evidence Act (Cap 80)
...
### Data Protection Act 2019 and Client Data Processing
...
- Cross-border data transfers must comply with the Act's requirements (adequate protection or appropriate safeguards)
- The **Office of the Data Protection Commissioner (ODPC)** oversees compliance
...
```
Example: "What does the Employment Act say about unfair termination?"
```
...
```
Example: "What are the penalties for corruption under the Anti-Corruption and Economic Crimes Act?"
```

- Query pattern may reveal you are working on an anti-corruption matter
...
3. Client matters: Use commercial legal databases (Mauritius Law Reports, LexisNexis East Africa)

### For Large Firms / Corporate Legal

1. Negotiate DPAs with AI service providers under Data Protection Act 2019 requirements
...
2. Follow Mauritian government information security requirements
...
- **Privacy Questions**: Open issue on [GitHub](https://github.com/Ansvar-Systems/mauritian-law-mcp/issues)
- **Anthropic Privacy**: Contact privacy@anthropic.com
- **LSK Guidance**: Consult Law Society of Mauritius ethics guidance
