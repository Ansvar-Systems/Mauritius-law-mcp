#!/usr/bin/env tsx
/**
 * Mauritius Law MCP -- Census Script
 *
 * Enumerates ALL proclamations, regulations, and directives from lawmauritian.com.
...
const BASE_URL = 'https://www.lawmauritian.com';
...
const FEDERAL_CATEGORIES = [
  ...
  'banking-and-monetary-system/national-bank-of-mauritian',
  ...
  'parliament', 'police', 'president-of-mauritian', 'prison',
...
async function scrapeCategoryPage(categoryPath: string): Promise<RawLaw[]> {
  ...
  for (const link of links) {
    ...
    if (link.href.startsWith('http') && !link.href.includes('lawmauritian.com')) continue;
...
async function main(): Promise<void> {
  ...
  console.log('Mauritius Law MCP -- Census Script');
  console.log('=================================\n');
  ...
  console.log(`  Jurisdiction:   Mauritius (ET)`);
  console.log(`  Source:         ${BASE_URL}`);
