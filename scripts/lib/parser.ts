/**
 * Mauritius Law PDF Parser
 *
 * Parses text extracted from Mauritian proclamation PDFs (Federal Negarit Gazette).
...
export function parseMauritiusLawHtml(html: string, act: ActIndexEntry): ParsedAct {
  return parsePdfText(html, act);
}
