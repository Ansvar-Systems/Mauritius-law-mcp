...
export async function listSources(
  ...
  return {
    results: {
      sources: [
        {
          name: 'Mauritian Legal Information Portal',
          authority: 'lawmauritian.com (Mauritian Legal Information Portal)',
          url: 'https://www.lawmauritian.com',
          license: 'Government Open Data',
          coverage:
            'Federal proclamations, regulations, and directives published in the Federal Negarit Gazette. ' +
            'Includes the Constitution of Mauritius (1995), major legislative acts from 1995 to present, ' +
