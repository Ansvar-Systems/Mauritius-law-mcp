/**
 * Tool registry for Mauritius Law MCP Server.
...
import { getMauritianImplementations, type GetMauritianImplementationsInput } from './get-mauritian-implementations.js';
...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'including Mauritius Law (National Council for Law Reporting). ' +
    ...
    'Call this FIRST when you need to understand what Mauritian legal data this server covers.',
  inputSchema: { type: 'object', properties: {} },
};
...
export const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search Mauritian statutes and regulations by keyword using full-text search (FTS5 with BM25 ranking). ' +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        status: {
          type: 'string',
          enum: ['in_force', 'amended', 'repealed', 'partially_suspended'],
  ...
  },
  {
    name: 'get_provision',
    description:
      'Retrieve the full text of a specific provision (article) from an Mauritian proclamation or regulation. ' +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        section: {
          type: 'string',
          description: 'Section/article number (e.g., "25", "31"). Omit to get all provisions.',
        },
        provision_ref: {
          type: 'string',
          description: 'Direct provision reference (e.g., "s25", "art31"). Alternative to section parameter.',
        },
      },
  ...
  },
  {
    ...
    description:
      'Validate an Mauritian legal citation against the database — zero-hallucination check. ' +
  ...
  },
  {
    ...
    description:
      'Build a comprehensive set of citations for a legal question by searching across all Mauritian statutes simultaneously. ' +
      'Returns aggregated results from multiple relevant provisions, useful for legal research on a topic. ' +
      'Use this for broad legal questions like "What are the penalties for data breaches in Mauritius?" ' +
  ...
  },
  {
    ...
    description:
      'Format a Mauritian legal citation per standard conventions. ' +
  ...
  },
  {
    name: 'check_currency',
    description:
      'Check whether an Mauritian proclamation or provision is currently in force, amended, or repealed. ' +
  ...
  },
  {
    name: 'get_eu_basis',
    description:
      'Get the EU/international legal basis that a Mauritian statute aligns with or references. ' +
      'Mauritius is not an EU member but several Mauritian laws were influenced by EU regulations ' +
    ...
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Mauritian statute identifier.' },
        include_articles: {
          type: 'boolean',
  ...
  {
    name: 'get_mauritian_implementations',
    description:
      'Find all Mauritian statutes that align with or implement a specific EU directive or regulation. ' +
      'Given an EU document ID (e.g., "regulation:2016/679" for GDPR), returns matching Mauritian statutes. ' +
      'Note: Mauritius implements international standards through domestic legislation influenced by international frameworks.',
    inputSchema: {
      type: 'object',
      properties: {
        eu_document_id: {
  ...
  },
  {
    ...
    description:
      'Search for EU directives and regulations that have Mauritian implementing/aligning legislation. ' +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        has_mauritian_implementation: {
          type: 'boolean',
          description: 'If true, only return EU documents with Mauritian aligning legislation.',
        },
  ...
  },
  {
    ...
    description:
      'Get the EU/international legal basis for a SPECIFIC provision within a Mauritian statute. ' +
  ...
  },
  {
    ...
    description:
      'Check EU/international alignment status for a Mauritian statute or provision. ' +
    ...
    try {
      ...
      switch (name) {
        ...
        case 'get_eu_basis':
          ...
          break;
        case 'get_mauritian_implementations':
          result = await getMauritianImplementations(db, args as unknown as GetMauritianImplementationsInput);
          break;
